...
- Start with [Getting Started](/en/guide/getting-started).
- Read [Core Package](/en/guide/core) if you only need the shared logic.
- Read [Vue Package](/en/guide/vue) if you want a drop-in Vue integration.
